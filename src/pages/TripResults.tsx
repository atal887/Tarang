      ...
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm font-medium text-slate-500 mt-1">
            {profile.location} &bull; {profile.vesselType} &bull; 3 Days
          </p>
        </div>
      </header>
          ...
          <CardContent className="p-5 md:p-6">
            <div className="flex flex-col md:flex-row gap-6 md:items-center">
              <div className="flex-1">
                ...
                <p className="text-sm font-medium text-slate-500 mb-4">{demoData.recommendedZone.distance} from {profile.location} Harbour</p>
                ...
                {!showMapConfirm ? (
                  ...
                  <div className="animate-in fade-in slide-in-from-right-4">
                    <p className="text-xs font-semibold text-slate-700 mb-3 text-center leading-tight">
                      Show safest route from {profile.location} to {demoData.recommendedZone.name}?
                    </p>
                    <div className="flex flex-col gap-2">
                      <Button onClick={() => navigate("/map?mode=route")} className="w-full h-10 text-sm">
                        Yes, Show Route
                      </Button>
